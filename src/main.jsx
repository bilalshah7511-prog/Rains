...
/**
 * iPhone Safari: layout viewport is taller than the visible area when the
 * bottom toolbar is showing. Drive fixed drawers/sheets from visualViewport
 * so CTAs (Continue / login) stay fully on-screen like Android Chrome.
 */
